...
<Callout type="info">
**New in v2.0:** GraphQL endpoint is available at `https://api.salsaasaservice.com/graphql`.
</Callout>
...
<CardGroup>
  <Card title="Authentication" href="#authentication">
    API keys, required headers, and examples.
  </Card>
  <Card title="Rate Limits" href="#rate-limits">
    Limits and response headers for monitoring.
  </Card>
...
<Callout type="info">
**API Key:** Get your API key from the <a href="https://app.salsaasaservice.com/settings/api">Developer Settings</a> in your dashboard.
</Callout>
...
If you’re close to `X-RateLimit-Remaining: 0`, back off and retry after `X-RateLimit-Reset`.
</Callout>
...
<Callout type="warning">
Sandbox uses test records and does not affect production.
</Callout>
